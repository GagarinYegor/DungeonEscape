...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(DungeonEscape game) {
        ...
        for (int i=0; i< levers.length; i++){
            levers[i] = new Lever(i+3, 1, i+3, 5, game.size, game.horisontal_otstup, game.vertical_otstup, game.activ_lever, game.passiv_lever, game.speed, game.uchd, game.uohd, game.slime_attacked_sound, game.slime_attacked_sound, game.slime_attacked_sound);
        }
